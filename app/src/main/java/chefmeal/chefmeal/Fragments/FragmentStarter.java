...
public class FragmentStarter extends Fragment {
    ...
    private List<String> listStarterName = new ArrayList<String>();
    private ArrayList<SearchResultItemActivity> starterList = new ArrayList<>();
     ...
     * @return A new instance of fragment FragmentStarter.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentStarter newInstance(String param1, String param2) {
        FragmentStarter fragment = new FragmentStarter();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        sLayout = view.findViewById(R.id.relative_starter);
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        db.collection("Recette")
                .whereEqualTo("idCat", 1)
                .get()
    ...
    public void createList(){
        ...
        mRecyclerView = getView().findViewById(R.id.starterList);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(getContext());
        mAdapter = new SearchResultAdapter(starterList);
        ...
        mAdapter.setOnClickListener(new SearchResultAdapter.OnClickItemListener() {
            ...
            public void onItemClick(int position) {
                ...
                toRecipe.putExtra("RecipeName", listStarterName.get(position));
